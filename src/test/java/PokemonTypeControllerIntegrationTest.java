...
class PokemonTypeControllerIntegrationTest {
    ...
    void getPokemon_withId25_ShouldReturnPikachu() {
        ...
        var pikachuResponseEntity = this.restTemplate.exchange("http://localhost:" + port + "/pokemon-types/25", HttpMethod.GET, httpRequest, PokemonType.class);
        var pikachu = pikachuResponseEntity.getBody();
    ...
    void getPokemon_withId1_shouldReturnBulbasaur() {
        ...
        var bulbasaur = bulbizarreResponseEntity.getBody();
